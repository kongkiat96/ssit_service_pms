...
<div class="modal-body">
    <div class="form-group row">
        <div class="col-md-5 col-sm-12">
            <label class="form-label-md fw-semibold mb-2" for="edit_menu_name">ชื่อเมนู</label>
            <input type="text" id="edit_menu_name" name="edit_menu_name" class="form-control" value="<?php echo $getmenu_detail->menu_name; ?>">
        </div>
        <div class="col-md-5 col-sm-12">
            <label class="form-label-md fw-semibold mb-2" for="edit_menu_icon">เปลี่ยนแปลงไอคอนเมนู <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank"><i class="fa fa-question-circle"></i></a></label>
        ...
        <div class="col-md-2 col-sm-12">
            <label class="form-label-md fw-semibold mb-2">Icon Menu</label>
            <p>
    ...
    <div class="form-group row">
        <div class="col-md-5 col-sm-12">
            <label class="form-label-md fw-semibold mb-2" for="edit_menu_folder">โฟลเดอร์</label>
            <input type="text" id="edit_menu_folder" name="edit_menu_folder" class="form-control" value="<?php echo $getmenu_detail->menu_case; ?>">
        </div>
        <div class="col-md-5 col-sm-12">
            <label class="form-label-md fw-semibold mb-2" for="edit_menu_link">Link menu</label>
        ...
        <div class="col-md-2 col-sm-12">
            <label class="form-label-md fw-semibold mb-2" for="sorting">ลำดับเมนู</label>
