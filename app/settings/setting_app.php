                ...
                <div class="tab-pane fade show active" id="navs-pills-justified-home" role="tabpanel">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 col-sm-12">
                                    <label class="form-label-md fw-semibold mb-2 mt-3" for="site_logo">โลโกบริษัท</label>
                                    <img src="../resource/system/logo/<?php echo @$getsystem_info->site_logo; ?>" width="256" alt="" />
                                    <div class="form-group">
                                        <input type="file" name="site_logo" id="site_logo" class="form-control input-sm mt-2" accept="image/png, image/jpeg">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <label class="form-label-md fw-semibold mb-2 mt-3" for="site_favicon">ไอคอนบริษัท</label>
                                    <img src="../resource/system/favicon/<?php echo @$getsystem_info->site_favicon; ?>" width="256" alt="" />
                                    <div class="form-group">
                                        <input type="file" name="site_favicon" id="site_favicon" class="form-control input-sm mt-2" accept="image/png, image/jpeg">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-12">
                                    <label class="form-label-md fw-semibold mb-2 mt-3" for="site_name">ชื่อบริษัท</label>
                                    <input type="text" class="form-control" name="site_name" id="site_name" value="<?php echo @$getsystem_info->site_name; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6 col-sm-12">
                                    <label class="form-label-md fw-semibold mb-2 mt-3" for="site_color_name">สีของชื่อบริษัท</label>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <label class="form-label-md fw-semibold mb-2 mt-3" for="site_color_form">สีของหน้าฟอร์ม</label>
                        ...
                        <div class="text-center mt-3">
                            ...
                            <button type="submit" name="save_info" class="btn btn-primary"><i class="bx bx-save"></i>
                                บันทึกข้อมูล</button>
                        </div>
                ...
                <div class="tab-pane fade " id="navs-pills-justified-profile" role="tabpanel">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="text-center mt-3">
                            ...
                            <button type="submit" name="save_alert" class="btn btn-primary"><i class="bx bx-save"></i>
                                บันทึกข้อมูล</button>
                        </div>
