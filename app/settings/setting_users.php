							...
							?>
								<tr>
									...
									<?php if (@$_SESSION['uclass'] == 3) { ?>
										...
										<td>
											<button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit_user" data-whatever="<?php echo @$showalluser->id; ?>" data-top="toptitle" data-placement="top" title="แก้ไข"><i class="fa fa-edit fa-fw"></i></button>
											<button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#access" data-whatever="<?php echo @$showalluser->user_key; ?>" data-top="toptitle" data-placement="right" title="การเข้าถึงเมนู"><i class="fa fa-sitemap fa-fw"></i></button>
											<?php
											if ($_SESSION['uclass'] == 3) { ?>
												...
												<a href="#" onclick="deletemployee('<?php echo @$showalluser->user_key; ?>');" class="btn btn-sm btn-danger" data-toggle="toptitle" data-placement="top" title="ลบรายการนี้"><i class="fa fa-times"></i></a>
											<?php } ?>
						...
						?>
							<tr>
								...
								<td>
									...
									<a href="#" onclick="restore('<?php echo @$showalluser->user_key; ?>');" class="btn btn-sm btn-danger" data-toggle="toptitle" data-placement="top" title="กู้รายการนี้"><i class="fa fa-reply"></i></a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
						...
						?>
							<tr>
								...
								<td>
									...
									<a href="#" onclick="restoreemployee('<?php echo @$showalluser->em_key ?>');" class="btn btn-sm btn-danger" data-toggle="toptitle" data-placement="top" title="กู้รายการนี้"><i class="fa fa-reply"></i></a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
