...
<div class="modal-body">
    <div class="text-end">
        ...
        <span class="fas fa-sync-alt"> แก้ไขข้อมูลเข้าพัก</span>
        </button> -->

        <a href="index.php?p=guest_detail&key=<?php echo $guest_detail->key_guest; ?>" class="btn btn-md btn-warning ml-auto" target="_blank"><span class="fas fa-sync-alt"> แก้ไขข้อมูลเข้าพัก</span></a>
