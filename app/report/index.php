...
if (isset($_POST['search'])) {
    if ($_POST['date_start'] != null && $_POST['date_end'] != null) {
        $getquery =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out,bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position, bm_guest.department AS g_department", "bm_guest", "check_in >= '" . $date_start . "'  AND check_in <= '" . $date_end . "' AND bm_guest.status != '9' AND bm_guest.building = '" . $building . "' ORDER BY bm_guest.building,bm_guest.floor,bm_guest.room ASC");

        $getquery2 =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.tel,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out,bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position,
        bm_guest_detail.prefix_name AS gdetail_prefix, bm_guest_detail.fname AS gdetail_fname,bm_guest_detail.lname AS gdetail_lname,bm_guest_detail.relation AS gdetail_relation", "bm_guest LEFT JOIN bm_guest_detail ON bm_guest_detail.code_guest = bm_guest.code", "check_in >= '" . $date_start . "'  AND check_in <= '" . $date_end . "' AND bm_guest.status != '9'AND bm_guest.building = '" . $building . "' ORDER BY building,bm_guest.floor,bm_guest.room ASC");
    } elseif ($_POST['date_start'] != null && $_POST['date_end'] == null) {
        $getquery =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out, bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position, bm_guest.department AS g_department", "bm_guest", "check_in >= '" . $date_start . "' AND bm_guest.status != '9' AND bm_guest.building = '" . $building . "' ORDER BY bm_guest.building,bm_guest.floor,bm_guest.room ASC");

        $getquery2 =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.tel,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out, bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position,
        bm_guest_detail.prefix_name AS gdetail_prefix, bm_guest_detail.fname AS gdetail_fname,bm_guest_detail.lname AS gdetail_lname,bm_guest_detail.relation AS gdetail_relation", "bm_guest LEFT JOIN bm_guest_detail ON bm_guest_detail.code_guest = bm_guest.code", "check_in >= '" . $date_start . "' AND bm_guest.status != '9' AND bm_guest.building = '" . $building . "' ORDER BY building,bm_guest.floor,bm_guest.room ASC");
    } elseif ($_POST['date_start'] == null && $_POST['date_end'] != null) {
        $getquery =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out, bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position, bm_guest.department AS g_department", "bm_guest", "check_in <= '" . $date_end . "' AND bm_guest.status != '9' AND bm_guest.building = '" . $building . "' ORDER BY bm_guest.building,bm_guest.floor,bm_guest.room ASC");

        $getquery2 =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.tel,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out, bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position,
        bm_guest_detail.prefix_name AS gdetail_prefix, bm_guest_detail.fname AS gdetail_fname,bm_guest_detail.lname AS gdetail_lname,bm_guest_detail.relation AS gdetail_relation", "bm_guest LEFT JOIN bm_guest_detail ON bm_guest_detail.code_guest = bm_guest.code", "check_in <= '" . $date_end . "' AND bm_guest.status != '9' AND bm_guest.building = '" . $building . "' ORDER BY building,bm_guest.floor,bm_guest.room ASC");
    } else if (!empty($building)) {
        $getquery =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out, bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position, bm_guest.department AS g_department", "bm_guest", "bm_guest.status != '9' AND bm_guest.building = '" . $building . "' ORDER BY building,bm_guest.floor,bm_guest.room ASC");
        $getquery2 =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.tel,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out, bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position, bm_guest.department AS g_department", "bm_guest", "bm_guest.status != '9' AND bm_guest.building = '" . $building . "' ORDER BY building,bm_guest.floor,bm_guest.room ASC");
    } else {
        $getquery =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out, bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position, bm_guest.department AS g_department", "bm_guest", "bm_guest.status != '9' ORDER BY building,bm_guest.floor,bm_guest.room ASC");

        $getquery2 =  $getdata->my_sql_select($connect, "bm_guest.building,bm_guest.tel,bm_guest.floor,bm_guest.end_date,bm_guest.status_guest_detail,bm_guest.status_guest,bm_guest.code AS code, bm_guest.status AS status, bm_guest.check_in AS check_in,bm_guest.check_out AS check_out, bm_guest.room AS room, bm_guest.prefix_name AS g_prefix, bm_guest.fname AS g_fname, bm_guest.lname AS g_lname, bm_guest.position AS g_position,
        bm_guest_detail.prefix_name AS gdetail_prefix, bm_guest_detail.fname AS gdetail_fname,bm_guest_detail.lname AS gdetail_lname,bm_guest_detail.relation AS gdetail_relation", "bm_guest LEFT JOIN bm_guest_detail ON bm_guest_detail.code_guest = bm_guest.code", "bm_guest.status != '9' ORDER BY building,bm_guest.floor,bm_guest.room ASC");
    }
}
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($show_total = mysqli_fetch_object($getquery2)) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php
                                                                if($show_total->check_out == '') {
                                                                    echo '-';
                                                                } else {
                                                                    echo dateConvertor($show_total->check_out);
                                                                }
                                                            ?></td>
