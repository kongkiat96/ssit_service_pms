...
<div class="modal-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4 col-sm-12 mb-3">
            ...
            <input type="tel" name="edit_tel" id="data2" onkeyup="autoTab2(this,2)" class="form-control input-sm" placeholder="หมายเลขโทรศัพท์" value="<?php echo $guest_list->tel; ?>" required>
            <div class="invalid-feedback">
