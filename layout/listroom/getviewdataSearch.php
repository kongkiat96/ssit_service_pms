...
$getRoom = explode('_', htmlspecialchars($_GET['key']));
$guest_detail = $getdata->my_sql_query($connect, NULL, "bm_guest", "building = '$getRoom[0]' AND floor = '$getRoom[1]' AND room='$getRoom[2]'");
?>
