...
document.addEventListener('DOMContentLoaded', function() {
    (function() {
        const calendarEl = document.getElementById('calendar'),
            ...
            eventticket = document.querySelector('#eventticket'),
        ...
        function eventClick(info) {
            ...
            if (offcanvasTitle) {
                offcanvasTitle.innerHTML = 'ตรวจสอบรายการแจ้งซ่อม';
            }
            ...
            eventToUpdate.extendedProps.location !== undefined ?
                ...
                null;
            eventToUpdate.extendedProps.status !== undefined ?
                (eventstatus.value = eventToUpdate.extendedProps.status) :
                null;
            eventToUpdate.extendedProps.location !== undefined ?
                (eventticket.value = eventToUpdate.extendedProps.ticket) :
                null;
